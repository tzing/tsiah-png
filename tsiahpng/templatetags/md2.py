"""
Django-markdown2
Original designed by svetlyak40wt, BSD-3-Clause
Modified by tzing for this project.
---
...
def markdown(value, arg=settings.MARKDOWN2_EXTRAS):
    """
    ...
    try:
        ...
        return mark_safe(
            markdown2.markdown(force_unicode(value), extras=extras, safe_mode=safe_mode)
        )
